      ...
      <div className="w-full max-w-sm space-y-8">
        <div className="text-center space-y-3">
          <div className="w-16 h-16 bg-indigo-600 rounded-2xl flex items-center justify-center mx-auto">
            <svg className="w-9 h-9 text-gray-100" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" />
            </svg>
          </div>
          <h1 className="text-3xl font-bold text-gray-100">RepSearch</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-3" noValidate>
          <input
            ...
            className="w-full bg-gray-900 border border-gray-800 focus:border-indigo-600 text-gray-100 py-4 px-5 rounded-2xl outline-none transition-colors"
          />
          {mode === 'register' && (
            <input
              type="text"
