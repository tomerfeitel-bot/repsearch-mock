export const RESEARCH_FIELDS = [
  ...
  { key: 'rest_seconds', label: 'Rest', type: 'rest', help: 'How long you rested before this set. Use the wheel like a phone timer picker.' },
...
export const TEMPLATE_RESEARCH_FIELDS = [
...
export function hasResearchValue(value) {
