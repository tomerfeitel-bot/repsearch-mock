...
- Progressive disclosure: simplest UI first, complexity on tap. Beginners see weight × reps; power users pin advanced fields.
...
## What NOT to do
No TypeScript. No ORM. No Redux/Zustand. No Puter. No AI features. No machine photo identification. No comments explaining WHAT code does — only non-obvious WHY. No documentation files unless explicitly asked. No new files unless necessary.
